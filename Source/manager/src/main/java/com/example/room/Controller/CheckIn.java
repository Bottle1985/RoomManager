...
public class CheckIn implements Initializable{
    ...
    private ObservableList<BookRoomModel> getTableBookRoom() {
        ...
        try {
            ...
            while (myReader.hasNextLine()) {
              ...
              if( bookdataStrings[7].equals("success" )) {
    ...
    @FXML
    public void CheckInRoom(ActionEvent event) throws IOException{
        tableBookRoom.getSelectionModel().getSelectedItem().setStatus("checkIn");
